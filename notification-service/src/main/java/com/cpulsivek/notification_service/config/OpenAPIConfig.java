...
@OpenAPIDefinition(
    info =
        @Info(
            ...
            description =
                "This documentation provides the detailed API specifications for the Notification Service "
                    + "of the Streaming microservice API. It includes all the available endpoints, their request "
                    + "and response formats, "
                    + "and other relevant details.",
            title = "Streaming Microservice API - Notification Service",
            version = "1.0.0",
            license = @License(name = "CpulsiveK")),
    servers = {
      @Server(description = "Development Server", url = "http://localhost:3006"),
      @Server(
